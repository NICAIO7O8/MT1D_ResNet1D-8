...
for i=1:NUM
    ...
    YPred8{i,1} = predict(resnet1d8net_500w,XTest{i});  %31层网络预测
end
...
for i=1:1:20
    ...
    YC_DZ31=fgyh(YPred8{m},max_output);  %预测数据反归一化
    [apparentResistivity18,phase18] = MT1DForward(YC_DZ18,h',B);
    [apparentResistivity31,phase31] = MT1DForward(YC_DZ31,h',B);
    table1=[jixian,apparentResistivity18,apparentResistivity31];
        figure(i)
...
legend('True Model apparentResistivity','Predicted apparentResistivity (ResNet1D-18)','Predicted apparentResistivity (ResNet1D-8)')
...
%% 可视化比较
 for i =150:10:200
    ...
    rmse_31=RMSE(YTest{m},YPred8{m});

    MAPE_18=MAPE(YTest{m},YPred18{m});
    MAPE_31=MAPE(YTest{m},YPred8{m});
        tabel2=[rmse_18,rmse_31,MAPE_18,MAPE_31]
